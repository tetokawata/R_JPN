...
X <- model.matrix(~ - 1+ black + nearc4 + smsa + south + 
                    black:nearc4 + black:smsa + black:south +
                    nearc4:smsa + nearc4:south +
                    smsa:south,
                  raw)
